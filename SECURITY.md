...
Provided by [Snyk](https://snyk.io/test/github/dbtedman/kata-amalgam) for validating package dependencies and [Dependabot](https://dependabot.com) for automated package updates.
